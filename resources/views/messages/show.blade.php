                        ...
                        <a href="{{ route('messages.show', $friendItem->uid) }}" 
                           ...
                           style="opacity: 1 !important; visibility: visible !important; color: #1c1c1c !important;">
                            ...
                            <div class="ms-3 flex-fill" style="min-width: 0; opacity: 1 !important; visibility: visible !important;">
                                <div class="fw-semibold text-truncate" style="color: #1c1c1c !important; opacity: 1 !important; visibility: visible !important;">{{ $friendItem->name }}</div>
                                @php
        ...
        <div class="col-md-8 col-lg-9 d-flex flex-column messenger-chat" style="background: linear-gradient(180deg, rgba(255, 254, 247, 0.5) 0%, rgba(180, 228, 255, 0.05) 50%, rgba(184, 230, 213, 0.05) 100%) !important; backdrop-filter: blur(5px) !important; opacity: 1 !important; visibility: visible !important; overflow: hidden; height: 100%;">
            ...
            <div class="p-3 border-bottom d-flex align-items-center gap-3" style="box-shadow: 0 4px 12px rgba(135, 206, 235, 0.2); opacity: 1 !important; visibility: visible !important; background: linear-gradient(135deg, rgba(160, 216, 239, 0.9) 0%, rgba(184, 230, 213, 0.9) 100%) !important; backdrop-filter: blur(10px) !important; border-bottom: 2px solid rgba(135, 206, 235, 0.3) !important; flex-shrink: 0;">
                ...
                <div class="flex-fill" style="opacity: 1 !important; visibility: visible !important;">
                    <h6 class="mb-0 fw-semibold" style="color: #1c1c1c !important; opacity: 1 !important; visibility: visible !important;">{{ $friend->name }}</h6>
            ...
            @forelse($messages as $message)
                ...
                @endphp
                <div class="mb-3 d-flex {{ $isOwnMessage ? 'justify-content-end' : 'justify-content-start' }}" style="opacity: 1 !important; visibility: visible !important;">
                    <div class="d-flex gap-2" style="max-width: 70%; {{ $isOwnMessage ? 'flex-direction: row-reverse;' : '' }} opacity: 1 !important; visibility: visible !important;">
                        ...
                        <div style="opacity: 1 !important; visibility: visible !important;">
                            ...
                            @else
                                <div class="rounded-pill px-3 py-2" style="background: {{ $isOwnMessage ? '#A0D8EF' : 'rgba(255, 254, 247, 0.95)' }}; color: {{ $isOwnMessage ? 'white' : '#050505' }};">
