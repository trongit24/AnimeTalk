...
<div class="chat-container">
    ...
    <div class="chat-messages" id="chat-messages">
        ...
        <div class="message {{ $message->is_pinned ? 'pinned' : '' }}" data-message-id="{{ $message->id }}">
            <div class="message-header">
                @if($message->user->profile_photo)
                <img src="{{ asset('storage/' . $message->user->profile_photo) }}" alt="{{ $message->user->name }}" class="message-avatar">
                @else
            ...
            <div class="message-content">
                ...
                @if($message->image)
                <img src="{{ asset('storage/' . $message->image) }}" alt="Message image" class="message-image">
                @endif
            </div>
        </div>
        @empty
