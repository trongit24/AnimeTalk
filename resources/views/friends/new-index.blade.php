                                ...
                                <div class="card border friend-card h-100">
                                    <div class="card-body p-3 text-center">
                                        ...
                                        <div class="d-grid gap-2">
                                            <a href="{{ route('profile.show', $friend->uid) }}" class="btn btn-sm btn-primary" style="background: linear-gradient(135deg, #A0D8EF 0%, #87CEEB 100%); border: none; color: white; font-weight: 500;">
                                                <i class="bi bi-person me-1"></i>Xem trang
                                            </a>
                                            <a href="{{ route('messages.show', $friend->uid) }}" class="btn btn-sm btn-success" style="background: linear-gradient(135deg, #B8E6D5 0%, #A0D8C3 100%); border: none; color: #2d5a4a; font-weight: 500;">
