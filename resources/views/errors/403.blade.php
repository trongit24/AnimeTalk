...
<body class="bg-gradient-to-br from-purple-50 to-pink-50 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center">
        ...
        <p class="text-gray-600 mb-8">
            {{ $exception->getMessage() ?: 'Bạn không có quyền truy cập trang này. Chỉ có quản trị viên mới có thể truy cập vào khu vực này.' }}
        </p>

        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('home') }}" class="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium rounded-lg hover:shadow-lg transition transform hover:-translate-y-0.5">
                Về trang chủ
            </a>
