...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/post-detail.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/style.css')); ?>">
    
    <!-- Anime Theme Override -->
    <link rel="stylesheet" href="<?php echo e(asset('css/anime-messages-override.css')); ?>">
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background: url('<?php echo e(asset('storage/image_4k/575436.jpg')); ?>') center/cover fixed,
...
<body style="background: url('<?php echo e(asset('storage/image_4k/575436.jpg')); ?>') center/cover fixed !important;">
    ...
    <nav class="modern-navbar">
        <div class="navbar-container">
            ...
            <div class="navbar-right">
                ...
                <a href="<?php echo e(route('login')); ?>" style="background: #FFFFFF; color: #4A90E2; padding: 0.5rem 1.5rem; border-radius: 8px; text-decoration: none; font-weight: 600; border: 2px solid #4A90E2; transition: all 0.3s;">Log in</a>
                <a href="<?php echo e(route('register')); ?>" style="background: #4A90E2; color: #FFFFFF; padding: 0.5rem 1.5rem; border-radius: 8px; text-decoration: none; font-weight: 600; border: 2px solid #4A90E2; margin-left: 0.5rem; transition: all 0.3s;">Sign up</a>
                <?php else: ?>
                ...
                <a href="<?php echo e(route('posts.create')); ?>" class="nav-icon-btn" title="Create Post">
                    <i class="bi bi-plus-circle"></i>
                </a>
                <a href="<?php echo e(route('events.index')); ?>" class="nav-icon-btn" title="Events">
                    <i class="bi bi-calendar-event"></i>
                </a>
                <a href="<?php echo e(route('friends.index')); ?>" class="nav-icon-btn" title="Friends">
                    <i class="bi bi-people"></i>
                </a>
                <a href="<?php echo e(route('messages.index')); ?>" class="nav-icon-btn" title="Messages" style="position: relative;">
                ...
                <a href="<?php echo e(route('notifications.index')); ?>" class="nav-icon-btn" title="Notifications" style="position: relative;">
                ...
                <div class="nav-profile-dropdown">
                    <button class="profile-btn">
                        <?php if(auth()->user()->profile_photo): ?>
                            <img src="<?php echo e(asset('storage/' . auth()->user()->profile_photo)); ?>" alt="<?php echo e(auth()->user()->name); ?>" class="profile-avatar-img">
                        <?php else: ?>
                    ...
                    <div class="dropdown-menu">
                        <a href="<?php echo e(route('profile.show')); ?>" style="display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem 1rem; border-bottom: 1px solid #e4e6eb;">
                            <?php if(auth()->user()->profile_photo): ?>
                                <img src="<?php echo e(asset('storage/' . auth()->user()->profile_photo)); ?>" alt="<?php echo e(auth()->user()->name); ?>" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;">
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                            <div>
                                <div style="font-weight: 600; color: #1c1c1c;"><?php echo e(auth()->user()->name); ?></div>
                        ...
                        <?php if(auth()->user()->role === 'admin'): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" style="color: #9B7EDE; font-weight: 600;">
    ...
    <div class="mobile-search-overlay" id="mobileSearchOverlay">
        <div class="search-overlay-header">
            ...
            <form action="<?php echo e(route('search')); ?>" method="GET" style="flex: 1;">
    ...
    <div class="notification-modal-overlay" id="notificationModal" onclick="closeNotification()">
        <div class="notification-modal" onclick="event.stopPropagation()">
            <div class="notification-icon <?php echo e(session('success') ? 'success' : 'error'); ?>">
            ...
            <div class="notification-content">
                <h3 class="notification-title"><?php echo e(session('success') ? 'Thành công!' : 'Lỗi!'); ?></h3>
                <p class="notification-message"><?php echo e(session('success') ?? session('error')); ?></p>
            </div>
            ...
            if (searchInput && searchSuggestions) {
                searchInput.addEventListener('input', function() {
                    ...
                    searchTimeout = setTimeout(function() {
                        fetch(`<?php echo e(route('search.autocomplete')); ?>?q=${encodeURIComponent(query)}`)
...
<?php /**PATH C:\xampp\htdocs\AnimeTalk\resources\views/layouts/app.blade.php ENDPATH**/ ?>