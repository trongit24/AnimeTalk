    ...
    <div class="hero-overlay">
        <div class="hero-content">
            ...
            <div class="hero-actions">
                <a href="<?php echo e(route('register')); ?>" class="btn-hero-primary">Get Started</a>
...
<div class="reddit-layout">
    ...
    <aside class="left-sidebar" id="leftSidebar">
        ...
        <div class="sidebar-section mt-4">
            ...
            <ul class="sidebar-menu">
                ...
                <?php if(auth()->guard()->check()): ?>
                <li>
                    <a href="<?php echo e(route('events.create')); ?>" class="sidebar-link">
    ...
    <main class="main-feed">
        ...
        <div class="category-tabs">
            <a href="<?php echo e(route('home', ['category' => 'all'])); ?>" 
               class="category-tab <?php echo e((!isset($category) || $category == 'all') ? 'active' : ''); ?>">
                <i class="bi bi-grid-3x3"></i> All
            </a>
            <a href="<?php echo e(route('home', ['category' => 'anime'])); ?>" 
               class="category-tab <?php echo e((isset($category) && $category == 'anime') ? 'active' : ''); ?>">
                <i class="bi bi-play-circle"></i> Anime
            </a>
            <a href="<?php echo e(route('home', ['category' => 'manga'])); ?>" 
               class="category-tab <?php echo e((isset($category) && $category == 'manga') ? 'active' : ''); ?>">
                <i class="bi bi-book"></i> Manga
            </a>
            <a href="<?php echo e(route('home', ['category' => 'cosplay'])); ?>" 
               class="category-tab <?php echo e((isset($category) && $category == 'cosplay') ? 'active' : ''); ?>">
                <i class="bi bi-mask"></i> Cosplay
            </a>
            <a href="<?php echo e(route('home', ['category' => 'discussion'])); ?>" 
               class="category-tab <?php echo e((isset($category) && $category == 'discussion') ? 'active' : ''); ?>">
        ...
        <div class="banner-carousel">
            <div class="banner-slider">
                <div class="banner-slide active" style="background-image: url('<?php echo e(asset('storage/image_4k/1311994.jpeg')); ?>');">
                    <div class="banner-overlay">
                        <h2>Discover Amazing Anime</h2>
                        <p>Join discussions with fans worldwide</p>
                    </div>
                </div>
                <div class="banner-slide" style="background-image: url('<?php echo e(asset('storage/image_4k/1316383.jpeg')); ?>');">
                    <div class="banner-overlay">
                        <h2>Share Your Passion</h2>
                        <p>Create posts and connect with community</p>
                    </div>
                </div>
                <div class="banner-slide" style="background-image: url('<?php echo e(asset('storage/image_4k/1319293.jpeg')); ?>');">
                    <div class="banner-overlay">
                        <h2>Explore Communities</h2>
                        <p>Find your tribe and make new friends</p>
                    </div>
                </div>
                <div class="banner-slide" style="background-image: url('<?php echo e(asset('storage/image_4k/1343086.jpeg')); ?>');">
                    <div class="banner-overlay">
                        <h2>Latest Anime News</h2>
                        <p>Stay updated with trending topics</p>
                    </div>
                </div>
                <div class="banner-slide" style="background-image: url('<?php echo e(asset('storage/image_4k/1345040.png')); ?>');">
                    <div class="banner-overlay">
                        <h2>Join Events</h2>
        ...
        <div class="create-box">
            <?php if(auth()->user()->profile_photo): ?>
                <img src="<?php echo e(asset('storage/' . auth()->user()->profile_photo)); ?>" alt="<?php echo e(auth()->user()->name); ?>" class="user-avatar-circle">
            <?php else: ?>
                <div class="user-avatar-circle"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 1))); ?></div>
            <?php endif; ?>
            <a href="<?php echo e(route('posts.create')); ?>" class="create-input">
                What's your favorite anime?
            </a>
            <div class="create-icons">
                <button class="icon-btn" onclick="window.location='<?php echo e(route('posts.create')); ?>'">
            ...
            <div class="card-body" style="padding: 0 !important;">
                ...
                <a href="<?php echo e(route('posts.show', $post->slug)); ?>" style="text-decoration: none; color: inherit; display: block;">
                    <?php if($post->background): ?>
                        ...
                        ?>
                        <div style="background: <?php echo e($bgGradient); ?>; min-height: 300px; border-radius: 12px; display: flex; align-items: center; justify-content: center; padding: 2rem; margin-bottom: 1rem;">
                    ...
                    <?php else: ?>
                        <p class="card-text" style="color: #1c1c1c !important; font-size: 1rem !important; line-height: 1.6 !important; margin-bottom: 1rem !important;"><?php echo e($post->content); ?></p>
                    <?php endif; ?>
                    
                    <?php if($post->image): ?>
                    <div class="card-image">
                        <img src="<?php echo e(asset('storage/' . $post->image)); ?>" alt="<?php echo e($post->title); ?>" loading="lazy">
                    </div>
                    <?php endif; ?>
                ...
                <div class="card-tags">
                    ...
                    <span class="tag-pill" style="background: <?php echo e($tag->color); ?>15; color: <?php echo e($tag->color); ?>">
                        <?php echo e($tag->name); ?>
                ...
                <div style="padding: 12px 0; border-bottom: 1px solid #e4e6eb; display: flex; justify-content: space-between; align-items: center; font-size: 14px; color: #65676b;">
                    <div>
                        ...
                        <span><i class="bi bi-heart-fill" style="color: #FF6B9D;"></i> <?php echo e($post->likes()->count()); ?></span>
                        <?php endif; ?>
                    </div>
                    <div>
                        <?php if($post->comments->count() > 0): ?>
                        <span><?php echo e($post->comments->count()); ?> bình luận</span>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <ul class="event-list">
                ...
                <li class="event-item" style="cursor: pointer;" onclick="window.location='<?php echo e(route('posts.show', $topPost->slug)); ?>'">
                    <?php if($topPost->background): ?>
                        ...
                        ?>
                        <div style="background: <?php echo e($bgGradient); ?>; width: 50px; height: 50px; border-radius: 8px; flex-shrink: 0; display: flex; align-items: center; justify-content: center; color: white; font-size: 18px; font-weight: 700; padding: 4px; text-align: center; line-height: 1.2; overflow: hidden;">
                            <span style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; font-size: 10px;">
                                <?php echo e(Str::limit($topPost->content, 20)); ?>

                            </span>
                        </div>
                    <?php elseif($topPost->video): ?>
                        <div style="width: 50px; height: 50px; border-radius: 8px; overflow: hidden; flex-shrink: 0; position: relative; background: #000;">
                            <video style="width: 100%; height: 100%; object-fit: cover;">
                                <source src="<?php echo e(asset('storage/' . $topPost->video)); ?>" type="video/mp4">
                            </video>
                    ...
                    <?php elseif($topPost->image): ?>
                        <img src="<?php echo e(asset('storage/' . $topPost->image)); ?>" alt="<?php echo e($topPost->title); ?>" 
                    ...
                    <?php else: ?>
                        <div style="background: linear-gradient(135deg, #5BA3D0, #9B7EDE); color: white; min-width: 50px; height: 50px; display: flex; align-items: center; justify-content: center; border-radius: 8px; font-weight: 700; font-size: 16px;">
                            <?php echo e(strtoupper(substr($topPost->user->name ?? 'A', 0, 1))); ?>

                        </div>
                    <?php endif; ?>
                    <div class="event-details">
                        <div class="event-title"><?php echo e(Str::limit($topPost->content, 40)); ?></div>
                        <div class="event-type" style="color: #FF6B6B; font-weight: 600;">
                            <?php echo e(number_format($topPost->interactions_count)); ?> tương tác
                        </div>
                    </div>
                </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <li class="event-item" style="cursor: pointer;" onclick="window.location='<?php echo e(route('communities.show', $community->slug)); ?>'">
                    <?php if($community->icon): ?>
                        <img src="<?php echo e(asset('storage/' . $community->icon)); ?>" alt="<?php echo e($community->name); ?>" 
                             style="width: 50px; height: 50px; border-radius: 8px; object-fit: cover; flex-shrink: 0; border: 2px solid <?php echo e($index == 0 ? '#FFD700' : ($index == 1 ? '#C0C0C0' : ($index == 2 ? '#CD7F32' : '#e0e0e0'))); ?>;">
                    <?php else: ?>
                        <div class="event-date" style="background: linear-gradient(135deg, <?php echo e($index == 0 ? '#FFD700, #FFA500' : ($index == 1 ? '#C0C0C0, #A8A8A8' : ($index == 2 ? '#CD7F32, #A0522D' : '#5BA3D0, #9B7EDE'))); ?>); color: white; min-width: 50px; height: 50px; display: flex; align-items: center; justify-content: center; border-radius: 8px; font-weight: 700; font-size: 1.25rem;">
                    ...
                    <div class="event-details">
                        <div class="event-title">
                            <span style="background: <?php echo e($index == 0 ? 'linear-gradient(135deg, #FFD700, #FFA500)' : ($index == 1 ? 'linear-gradient(135deg, #C0C0C0, #A8A8A8)' : ($index == 2 ? 'linear-gradient(135deg, #CD7F32, #A0522D)' : 'linear-gradient(135deg, #5BA3D0, #9B7EDE)'))); ?>; color: white; padding: 0.125rem 0.375rem; border-radius: 4px; font-size: 0.7rem; font-weight: 700; margin-right: 0.375rem;">#<?php echo e($index + 1); ?></span>
                            <?php echo e(Str::limit($community->name, 25)); ?>

                        </div>
                        <div class="event-type" style="color: #667eea; font-weight: 600;">
                            <i class="bi bi-people-fill"></i> <?php echo e(number_format($community->members_count)); ?> members
                        </div>
                    </div>
                </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_setup\AnimeTalk\resources\views/home-new.blade.php ENDPATH**/ ?>