...
<?php $__env->startSection('title', 'Edit Event - AnimeTalk'); ?>
...
<div style="background: #F0F2F5; min-height: calc(100vh - 60px); padding: 2rem 0; opacity: 1 !important; visibility: visible !important;">
    <div style="max-width: 800px; margin: 0 auto; padding: 0 1rem;">
        <div style="background: white; border-radius: 12px; padding: 2rem; border: 1px solid #e0e0e0;">
            ...
            <form action="<?php echo e(route('events.update', $event->slug)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                    <div>
                        ...
                        <input type="datetime-local" name="start_time" value="<?php echo e(old('start_time', $event->start_time->format('Y-m-d\TH:i'))); ?>" required
                               style="width: 100%; padding: 0.75rem 1rem; border: 1px solid #e0e0e0; border-radius: 8px; font-size: 1rem;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="end_time" value="<?php echo e(old('end_time', $event->end_time?->format('Y-m-d\TH:i'))); ?>"
                               style="width: 100%; padding: 0.75rem 1rem; border: 1px solid #e0e0e0; border-radius: 8px; font-size: 1rem;">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <img src="<?php echo e(asset('storage/' . $event->cover_image)); ?>" alt="Current cover" 
                         style="width: 100%; height: 200px; object-fit: cover; border-radius: 8px; border: 2px solid #e0e0e0;">
                </div>
                <?php endif; ?>
                ...
                <div style="margin-bottom: 1.5rem;">
                    <label style="display: block; font-weight: 600; margin-bottom: 0.5rem; color: #333;">
                        <?php echo e($event->cover_image ? 'Change Cover Image' : 'Cover Image'); ?>
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                        <label style="display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 8px; cursor: pointer;">
                            <input type="radio" name="privacy" value="public" <?php echo e(old('privacy', $event->privacy) == 'public' ? 'checked' : ''); ?> required
                        ...
                        <label style="display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 8px; cursor: pointer;">
                            <input type="radio" name="privacy" value="friends" <?php echo e(old('privacy', $event->privacy) == 'friends' ? 'checked' : ''); ?>
                        ...
                        <label style="display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem; border: 1px solid #e0e0e0; border-radius: 8px; cursor: pointer;">
                            <input type="radio" name="privacy" value="private" <?php echo e(old('privacy', $event->privacy) == 'private' ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AnimeTalk\resources\views/events/edit.blade.php ENDPATH**/ ?>