...
<?php $__env->startSection('title', $event->title . ' - AnimeTalk'); ?>
...
<div style="background: #F0F2F5; min-height: calc(100vh - 60px); opacity: 1 !important; visibility: visible !important;">
    <!-- Cover Image -->
    <div style="width: 100%; height: 400px; background: <?php echo e($event->cover_image ? 'url(' . asset('storage/' . $event->cover_image) . ')' : 'linear-gradient(135deg, #5BA3D0, #9B7EDE)'); ?>; background-size: cover; background-position: center; position: relative;">
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 1.5rem;">
            ...
            <div>
                ...
                <div style="background: white; border-radius: 12px; padding: 2rem; border: 1px solid #e0e0e0; margin-bottom: 1.5rem;">
                    <h1 style="font-size: 2.25rem; font-weight: 700; margin-bottom: 1rem;"><?php echo e($event->title); ?></h1>
                    ...
                    <div style="display: flex; flex-wrap: wrap; gap: 1.5rem; margin-bottom: 1.5rem;">
                        <div style="display: flex; align-items: center; gap: 0.75rem; color: #666;">
                            ...
                            <div>
                                ...
                                <div style="font-weight: 600;"><?php echo e($event->start_time->format('F j, Y')); ?></div>
                            </div>
                        </div>
                        ...
                        <div style="display: flex; align-items: center; gap: 0.75rem; color: #666;">
                            ...
                            <div>
                                ...
                                <div style="font-weight: 600;"><?php echo e($event->start_time->format('g:i A')); ?>

                                <?php if($event->end_time): ?>
                                    - <?php echo e($event->end_time->format('g:i A')); ?>
                        ...
                        <div style="display: flex; align-items: center; gap: 0.75rem; color: #666;">
                            ...
                            <div>
                                ...
                                <div style="font-weight: 600;"><?php echo e($event->location); ?></div>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div style="display: flex; align-items: center; gap: 1rem; padding: 1rem; background: #f9f9f9; border-radius: 8px; margin-bottom: 1.5rem;">
                        <?php if($event->owner->profile_photo): ?>
                        <img src="<?php echo e(asset('storage/' . $event->owner->profile_photo)); ?>" alt="<?php echo e($event->owner->name); ?>" 
                        ...
                        <div style="width: 50px; height: 50px; border-radius: 50%; background: linear-gradient(135deg, #5BA3D0, #9B7EDE); color: white; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 1.25rem;">
                            <?php echo e(strtoupper(substr($event->owner->name, 0, 1))); ?>

                        </div>
                        <?php endif; ?>
                        <div style="flex: 1;">
                            <div style="font-size: 0.85rem; color: #999;">Hosted by</div>
                            <a href="<?php echo e(route('profile.show', $event->owner->uid)); ?>" style="font-weight: 600; font-size: 1.05rem; color: #333; text-decoration: none;">
                                <?php echo e($event->owner->name); ?>
                    ...
                    <div style="display: flex; gap: 1rem;">
                        <form action="<?php echo e(route('events.respond', $event->id)); ?>" method="POST" style="flex: 1;">
                            ...
                            <button type="submit" 
                                    style="width: 100%; padding: 0.875rem; background: <?php echo e($event->getParticipantStatus(auth()->user()) === 'going' ? '#28a745' : 'linear-gradient(135deg, #5BA3D0, #9B7EDE)'); ?>; color: white; border: none; border-radius: 8px; font-weight: 600; cursor: pointer; font-size: 1rem;">
                                <i class="bi bi-check-circle-fill"></i> 
                                <?php echo e($event->getParticipantStatus(auth()->user()) === 'going' ? 'Going' : 'Join Event'); ?>
                        ...
                        <form action="<?php echo e(route('events.respond', $event->id)); ?>" method="POST" style="flex: 1;">
                            ...
                            <button type="submit" 
                                    style="width: 100%; padding: 0.875rem; background: <?php echo e($event->getParticipantStatus(auth()->user()) === 'interested' ? '#ffc107' : '#f0f0f0'); ?>; color: <?php echo e($event->getParticipantStatus(auth()->user()) === 'interested' ? 'white' : '#333'); ?>; border: 1px solid #e0e0e0; border-radius: 8px; font-weight: 600; cursor: pointer; font-size: 1rem;">
                                <i class="bi bi-star"></i> 
                                <?php echo e($event->getParticipantStatus(auth()->user()) === 'interested' ? 'Interested' : 'Interested'); ?>
                ...
                <div style="background: white; border-radius: 12px; padding: 2rem; border: 1px solid #e0e0e0; margin-bottom: 1.5rem;">
                    ...
                    <p style="color: #555; line-height: 1.8; white-space: pre-wrap;"><?php echo e($event->description); ?></p>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div>
                ...
                <div style="background: white; border-radius: 12px; padding: 1.5rem; border: 1px solid #e0e0e0; margin-bottom: 1.5rem; position: sticky; top: 80px;">
                    ...
                    <?php if($interestedUsers->count() > 0): ?>
                    <div style="padding: 1rem; background: rgba(255, 193, 7, 0.1); border-radius: 8px; margin-bottom: 1rem; text-align: center;">
                        <div style="font-size: 1.5rem; font-weight: 700; color: #ffc107;"><?php echo e($interestedUsers->count()); ?></div>
                    ...
                    <div style="display: flex; align-items: center; justify-content: center; gap: 0.5rem; padding: 0.75rem; background: #f9f9f9; border-radius: 8px; margin-top: 1rem;">
                        <i class="bi bi-<?php echo e($event->privacy === 'public' ? 'globe' : 'lock'); ?>"></i>
                        <span style="font-weight: 600; text-transform: capitalize;"><?php echo e($event->privacy); ?> Event</span>
                    </div>
                </div>
                ...
                <div style="background: white; border-radius: 12px; padding: 1.5rem; border: 1px solid #e0e0e0;">
                    <h3 style="font-size: 1.1rem; font-weight: 700; margin-bottom: 1rem;">
                        Going (<?php echo e($goingUsers->count()); ?>)
                    </h3>
                    <div style="max-height: 400px; overflow-y: auto;">
                        <?php $__empty_1 = true; $__currentLoopData = $goingUsers->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div style="display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem 0; border-bottom: 1px solid #f0f0f0;">
                            ...
                            <div style="flex: 1; min-width: 0;">
                                <a href="<?php echo e(route('profile.show', $user->uid)); ?>" style="font-weight: 600; font-size: 0.9rem; color: #333; text-decoration: none; display: block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                        ...
                        <?php if($goingUsers->count() > 10): ?>
                        <div style="text-align: center; padding-top: 1rem;">
                            <span style="color: #5BA3D0; font-weight: 600;">+<?php echo e($goingUsers->count() - 10); ?> more</span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AnimeTalk\resources\views/events/show.blade.php ENDPATH**/ ?>