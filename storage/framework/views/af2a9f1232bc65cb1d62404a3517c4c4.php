<?php $__env->startSection('title', 'Bạn bè - AnimeTalk'); ?>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        <h5 class="mb-3 fw-semibold">
                            ...
                            <span class="badge bg-primary rounded-pill"><?php echo e(count($pendingRequests)); ?></span>
                        </h5>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6" id="pending-<?php echo e($request->id); ?>">
                                <div class="card border pending-request-card">
                                    <div class="card-body p-3">
                                        <div class="d-flex align-items-center">
                                            <img 
                                                src="<?php echo e($request->user->profile_photo ? asset('storage/' . $request->user->profile_photo) : asset('images/default-avatar.png')); ?>" 
                                                class="rounded-circle me-3" 
                                                style="width: 50px; height: 50px; object-fit: cover;"
                                                alt="<?php echo e($request->user->name); ?>"
                                            >
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><?php echo e($request->user->name); ?></h6>
                    ...
                    <div>
                        <h5 class="mb-3 fw-semibold">
                            ...
                            <span class="badge bg-secondary rounded-pill"><?php echo e(count($friends)); ?></span>
                        </h5>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" id="friend-<?php echo e($friend->uid); ?>">
                                <div class="card border friend-card h-100">
                                    <div class="card-body p-3 text-center">
                                        <img 
                                            src="<?php echo e($friend->profile_photo ? asset('storage/' . $friend->profile_photo) : asset('images/default-avatar.png')); ?>" 
                                            class="rounded-circle mb-2" 
                                            style="width: 80px; height: 80px; object-fit: cover;"
                                            alt="<?php echo e($friend->name); ?>"
                                        >
                                        <h6 class="mb-1"><?php echo e($friend->name); ?></h6>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_setup\AnimeTalk\resources\views/friends/new-index.blade.php ENDPATH**/ ?>