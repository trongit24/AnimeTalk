<?php $__env->startSection('title', 'Create Post - AnimeTalk'); ?>
    ...
    <div class="fb-post-card">
        <form action="<?php echo e(route('posts.store')); ?>" method="POST" enctype="multipart/form-data" id="postForm">
            ...
            <div class="fb-content-area">
                ...
                <input type="hidden" name="title" id="titleField" value="<?php echo e(old('title')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_setup\AnimeTalk\resources\views/posts/create.blade.php ENDPATH**/ ?>