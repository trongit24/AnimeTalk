    ...
    <div class="container" style="max-width: 900px; margin: 0 auto;">
        ...
        <div style="background: white; border-radius: 16px; padding: 2rem; margin-bottom: 2rem; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
            <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                <a href="<?php echo e(route('events.show', $event->slug)); ?>" style="color: #5BA3D0; text-decoration: none;">
                    <i class="bi bi-arrow-left" style="font-size: 1.5rem;"></i>
                </a>
                <div>
                    <h1 style="margin: 0; color: #2c3e50; font-size: 1.75rem;">Thông báo Sự kiện</h1>
                    <p style="margin: 0.25rem 0 0 0; color: #666;"><?php echo e($event->title); ?></p>
                </div>
            </div>
        </div>
        ...
        <?php if($notifications->count() > 0): ?>
            <div style="background: white; border-radius: 16px; padding: 1.5rem; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
                <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="padding: 1.25rem; border-bottom: 1px solid #f0f0f0; display: flex; align-items: start; gap: 1rem; <?php echo e(!$notification->is_read ? 'background: #f0f7ff;' : ''); ?> border-radius: 8px; margin-bottom: 0.5rem;">
                        <!-- Icon based on type -->
                        <div style="flex-shrink: 0;">
                            <?php if($notification->type === 'event_invitation'): ?>
                            ...
                            <?php elseif($notification->type === 'event_reminder'): ?>
                            ...
                            <?php elseif($notification->type === 'event_update'): ?>
                        ...
                        <div style="flex: 1;">
                            ...
                            <?php if(!$notification->is_read): ?>
                                <form action="<?php echo e(route('events.notifications.read', $notification->id)); ?>" method="POST" style="margin-top: 0.75rem;">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AnimeTalk\resources\views/events/notifications.blade.php ENDPATH**/ ?>